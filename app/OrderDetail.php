...
class OrderDetail extends Model
{
    ...
    protected $fillable = ['sales_id', 'product_id','ProductName','ProductCode','ProductPrice','LKPP','ProposedPrice','Quantity','Accepted','RecommendedPrice','Status','created_at','updated_at'];
    protected $guarded =[];
    protected $appends = [
        'margin',
        'totalproposedprice',
